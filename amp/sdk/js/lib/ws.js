...
module.exports = function (uri, onMessage_, onChange_) {
  // TODO get rid of this suffix_
  ...
  function onMessage(data) {
    // expecting that onMessage returns true if it is a pong message
    try {
  ...
  var ws = null,
    ...
    event: function event(name, e) {
      var o = {
        ...
        sinceConnect: now() - status.startConnect
      };
